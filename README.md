...
[![Build Status](https://travis-ci.org/the-road-to-react-with-firebase/scorecard.svg?branch=master)](https://travis-ci.org/the-road-to-react-with-firebase/scorecard) [![Slack](https://slack-the-road-to-learn-react.wieruch.com/badge.svg)](https://slack-the-road-to-learn-react.wieruch.com/) [![Greenkeeper badge](https://badges.greenkeeper.io/the-road-to-react-with-firebase/scorecard.svg)](https://greenkeeper.io/)
...
* `git clone git@github.com:the-road-to-react-with-firebase/scorecard.git`
* `cd scorecard`
* `npm install`
* `npm start`
