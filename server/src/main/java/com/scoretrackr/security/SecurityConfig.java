...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/scoretrackr/mFormat").permitAll()
                .antMatchers(HttpMethod.GET, "/scoretrackr/mFormat/{mFormatId}").permitAll()
                .antMatchers(HttpMethod.POST, "/scoretrackr/mFormat").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.GET, "/scoretrackr/type").permitAll()
                .antMatchers(HttpMethod.GET, "/scoretrackr/type/{matchTypeId}").permitAll()
                .antMatchers(HttpMethod.POST, "/scoretrackr/type").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.GET, "/scoretrackr/sType").permitAll()
                .antMatchers(HttpMethod.GET, "/scoretrackr/sType/{sTypeId}").permitAll()
                .antMatchers(HttpMethod.POST, "/scoretrackr/sType").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.GET, "/scoretrackr/team/{teamId}").permitAll()
                .antMatchers(HttpMethod.POST, "/scoretrackr/team").hasAnyAuthority("USER", "ADMIN")
